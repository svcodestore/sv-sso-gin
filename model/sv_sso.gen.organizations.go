...
// WithStatus status获取
func (obj *_OrganizationsMgr) WithStatus(status uint8) Option {
...
func (obj *_OrganizationsMgr) GetFromStatus(status uint8) (results []*Organizations, err error) {
...
func (obj *_OrganizationsMgr) GetBatchFromStatus(statuss []uint8) (results []*Organizations, err error) {
